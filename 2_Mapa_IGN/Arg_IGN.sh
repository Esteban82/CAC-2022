...
#	S=$(echo 0 -70 | gmt mapproject -Rg -J$PROJ -C -Fk -o1)	
...
#	Pintar areas secas (-G). Usar linea de costa para Antartida (-A+ag) en lugar de frente de hielo.
	gmt coast -Df -G245/241/214 -S199/224/246 -A+ag		# Antartida con costa segun limite tierra-mar. 

#	Dibujar limite de paises
	gmt coast -Df -N1/faint,dashed
